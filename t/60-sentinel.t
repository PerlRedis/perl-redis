...
print STDERR "redis address : $redis_addr\n";
print STDERR "redis port : $redis_port\n";
...
print STDERR "sentinel address: $sentinel_addr\n";
...
delete $got->{$_} for qw(last-ok-ping-reply last-ping-reply runid role-reported-time info-refresh);
